 ...
 */
public class WifiDirect_DeviceList_backup extends Activity {
    ...
    public void browseForFile(View view) {
        Intent clientStartIntent = new Intent(getApplicationContext(), FileBrowser.class);
        ...
        if(!transferActive)
        {
	        ...
	        */
            ...
            else
            {
                ...
                clientServiceIntent = new Intent(this, WifiDirectController.class);
